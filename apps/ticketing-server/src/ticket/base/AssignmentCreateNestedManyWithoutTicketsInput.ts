...
@InputType()
class AssignmentCreateNestedManyWithoutTicketsInput {
...
export { AssignmentCreateNestedManyWithoutTicketsInput as AssignmentCreateNestedManyWithoutTicketsInput };
